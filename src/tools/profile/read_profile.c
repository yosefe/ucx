...
static int show_profile_data_accum(profile_data_t *data, options_t *opts)
{
    ...
    locations_thread_info = calloc(sizeof(*locations_thread_info), num_locations);
...
static void usage()
{
    ...
    printf("  -T <threads>    Comma-separated list of threads to show, e.g. \"1,2,3\"\n");
