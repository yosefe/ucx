...
ucp_proto_rndv_rtr_common_init(const ucp_proto_init_params_t *init_params,
                               uint64_t rndv_modes, unsigned flags,
                               size_t max_length, ucs_linear_func_t unpack_time,
...
ucp_proto_rndv_rtr_init(const ucp_proto_init_params_t *init_params)
{
    ...
    status = ucp_proto_rndv_rtr_common_init(
            init_params, rndv_modes, UCP_PROTO_COMMON_INIT_FLAG_SEND_ZCOPY,
            SIZE_MAX, UCS_LINEAR_FUNC_ZERO, NULL,
...
ucp_proto_rndv_rtr_mtype_init(const ucp_proto_init_params_t *init_params)
{
    ...
    status = ucp_proto_rndv_rtr_common_init(init_params, rndv_modes, 0,
                                            frag_size, unpack_time,
                                            unpack_perf_node,
