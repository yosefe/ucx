...
#define HAVE_MPI_2COMPLEX 1

/* Define if MPI_2DOUBLE_COMPLEX is available */
#define HAVE_MPI_2DOUBLE_COMPLEX 1
...
#define PACKAGE_STRING "mpich-testsuite 3.3a1"
